...
public final class A_subclass extends C_subclass {
    ...
    public final void a(n var1, Graphics var2) {
        ...
        if (var6) {
            ...
            var2.fillRect(0, this.e + var4.height, var3, 1 * var1.f);
            var2.fillRect(0, this.e + var4.height + var5.height + 1 * var1.f, var3, 3 * var1.f);
            var2.fillRect(0, this.e, var1.e, this.e + var4.height + var5.height + 4 * var1.f);
        }

        var1.d(var2);
        int var7 = this.f;
        var2.drawString(this.j, 0, var7);
