...
public final class g extends o {
   ...
   public final void a(Graphics var1) {
      ...
      int var6 = this.e;
      int var7 = this.b.q().m();
      var1.drawLine(var6, 1 * this.f, var2 / 2, 1 * this.f);
      var1.drawLine(var2 / 2, 1 * this.f, var2 / 2 - var7, 1 * this.f - var7);
      var1.drawLine(var2 / 2, 1 * this.f, var2 / 2 - var7, 1 * this.f + var7);
      var1.drawLine(var6, 1 * this.f, var6, var3 - (this.o / 2 + 2 * this.f));
   ...
   public final void a() {
      ...
      this.p = (int)((double)(this.o / 2 + var3 / 2 - 1 * this.f) + var10.getHeight() / 2.0D + var10.getY());
      int var11 = 2 * this.e;
      int var5 = 2 * this.e;
      int var6 = 2 * this.f;
      int var7 = 2 * this.f;
      ...
      this.a((Dimension)(new Dimension(var11 + var9 + var5, (int)((double)(this.o + var6 + var7) + var8.getHeight()))));
   ...
   protected final void a_() {
      ...
      a.a.f.a(this.c.a(), (package_a.c.b.e)this.i);
