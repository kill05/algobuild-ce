...
public final class d extends JDialog implements ActionListener {
   ...
   public d(Window var1, String var2) {
      ...
      ImageIcon var3 = a.i.b.a("imgs/run_icon.gif");
      ImageIcon var4 = a.i.b.a("imgs/pause_icon.gif");
      ...
      e var5 = new e(this);
      f var6 = new f(this);
      this.c.getInputMap(2).put(KeyStroke.getKeyStroke(27, 0), var5);
      this.c.getInputMap(2).put(KeyStroke.getKeyStroke(120, 0), var6);
