package com.github.kill05.algobuildce.package_a.dialogs;

import com.github.kill05.algobuildce.package_a.c.a.AlgoBuild;
import com.github.kill05.algobuildce.package_a.c.blocks.ABWhileBlock;
...
public final class j extends JDialog implements ActionListener, KeyListener, DocumentListener {
   private JButton a;
   private JButton b;
   private JTextArea c = new JTextArea();
   private String d;
   private String e;
   private ABWhileBlock f;
   private static j g = null;
   private static boolean h = false;

   private j(Window var1, ABWhileBlock var2, Point var3) {
      super((Frame)var1, Translator.translate("abedDialogCycleWhileTitle"), true);
      ...
      JTextArea var4;
      (var4 = new JTextArea(Translator.translate("abedDialogCycleWhileCondition"))).setEditable(false);
   ...
   public static boolean a(Window var0, ABWhileBlock var1) {
      Point var2;
      (var2 = MouseInfo.getPointerInfo().getLocation()).translate(15, 15);
      if (g == null) {
         g = new j(var0, var1, var2);
      }
