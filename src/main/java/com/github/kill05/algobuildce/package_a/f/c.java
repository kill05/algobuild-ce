   ...
   private void c() {
      try {
         ...
         if (this.h == 0) {
            ...
            var9 = com.github.kill05.algobuildce.package_a.f.k.a().e();
            var25 = com.github.kill05.algobuildce.package_a.f.k.a().f();
         ...
         if (this.h == 2) {
            ...
            if ((var17 = new File(this.i, this.k)).exists()) {
               ...
               var21.read(var19);
               var21.close();
            } else if ((var19 = com.github.kill05.algobuildce.package_a.f.d.a(com.github.kill05.algobuildce.package_a.f.k.a().b(), this.l)) != null && var19.length > 0) {
