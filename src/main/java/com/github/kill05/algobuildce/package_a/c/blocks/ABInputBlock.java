package com.github.kill05.algobuildce.package_a.c.blocks;
...
public final class ABInputBlock extends k {
   public ABInputBlock(String var1) {
      super(var1);
   }
   ...
   public final int a(ABProgram var1, int var2) {
      ...
      for(int var3 = 0; var13 != null && var3 < var13.length; ++var3) {
         ...
         try {
            ...
            return -2;
         } catch (ABInstructionException var12) {
   ...
   public final String toString() {
      return this.getOrderInParent() + "- ABIIOInput: " + this.k().replace("\n", ", ") + "\n";
   }

   @Override
   public final ABExecutable copy() {
      return new ABInputBlock(this.k());
   }
