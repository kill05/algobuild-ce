...
public class ABFrameHolder {
    ...
    private ActionMap createActionMap() {
        ...
        actionMap.putAction(name, var12);
        name = "mnuEditRedo";
        ...
        actionMap.putAction(name, var16);
        name = "execPause";
        var3 = Translator.translate("execPause");
        var4 = ImageUtils.loadImage("imgs/pause_icon.gif");
        PauseAction var17;
        (var17 = new PauseAction(this, var3, var4)).setEnabled(false);
        actionMap.putAction(name, var17);
        name = "execInterrupt";
        ...
        actionMap.putAction(name, var18);
        name = "execOptions";
        ...
        actionMap.putAction(name, var19);
        Locale var5 = Translator.getLocale();
        name = "mnuLanguageItalian";
        ...
        actionMap.putAction(name, var20);
        name = "mnuLanguageEnglish";
